...
const { login, logout, getProfile, issueCertificate, fetchallCertificates, nonce, updateProfile } = require('../controllers/InstituteController');
...
router.patch('/profile', instituteMiddleware, updateProfile);
